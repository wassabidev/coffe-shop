...
const StatusView = ({ loading, error, empty }) => {
    if (loading) {
        return (
            <div className='flex justify-center items-center h-screen w-full'>
                <svg className='opacity-50 w-20 h-20' viewBox="0 0 73 85" role="img" id="skeleton-loadingCoffeeCup">
                    <g>
                        ...
                        <path className="animate-steam" id="skeleton-loadingCoffeeSteam" stroke="#2d2926" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M31 26.333c0-2.89 4.063-2.89 4.063-5.777 0-2.89-4.063-2.89-4.063-5.778 0-2.89 4.063-2.89 4.063-5.778M38 26.333c0-2.89 4.063-2.89 4.063-5.777 0-2.89-4.063-2.89-4.063-5.778 0-2.89 4.063-2.89 4.063-5.778"></path>
                    </g>
                </svg>
            </div>
        )
    ...
    if (error) {
        return (
            <div className='flex justify-center items-center h-screen w-full'>
                <h2 className='text-2xl font-bold text-red-500'>Error al cargar los datos</h2>
            </div>
        )
    }
    if (empty) {
        return (
            <div className='flex justify-center items-center h-screen w-full'>
                <h2 className='text-2xl font-bold text-gray-500'>No hay productos disponibles</h2>
            </div>
        )
    }
    return null
